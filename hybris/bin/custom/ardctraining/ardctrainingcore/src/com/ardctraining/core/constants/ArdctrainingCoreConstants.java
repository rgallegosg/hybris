 ...
 */
package com.ardctraining.core.constants;

/**
 * Global class for all ArdctrainingCore constants. You can add global constants for your extension into this class.
 */
public final class ArdctrainingCoreConstants extends GeneratedArdctrainingCoreConstants
{
	public static final String EXTENSIONNAME = "ardctrainingcore";


	private ArdctrainingCoreConstants()
	{
		//empty
	}
