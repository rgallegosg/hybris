 ...
 */
package com.ardctraining.test.setup;
...
import com.ardctraining.test.constants.ArdctrainingTestConstants;
import com.ardctraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ArdctrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ardctrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ardctrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ardctrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/ardctrainingtest/import/csquotes.impex");
		}
	}
}
