...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ardctrainingstorefront/electronics/en",
						"https://electronics.local:9002/ardctrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ardctrainingstorefront/electronics/en",
						"https://electronics.local:9002/ardctrainingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ardctrainingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ardctrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ardctrainingstorefront/electronics/en",
						"https://electronics.local:9002/ardctrainingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ardctrainingstorefront",
						"https://electronics.local:9002/ardctrainingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ardctrainingstorefront",
						"https://electronics.local:9002/ardctrainingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ardctrainingstorefront/electronics/en",
						"https://electronics.local:9002/ardctrainingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
