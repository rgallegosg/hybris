 ...
 */
package com.ardctraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ArdctrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ArdctrainingFulfilmentProcessConstants.PARENT_PROCESS);
